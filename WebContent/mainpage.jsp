...
<div class="navbar">
  ...
  <%
  //out.println(request.getParameter("typese"));
  if(request.getParameter("typese").equals("university"))
  {
	  %>
	  	<div class="dropdown">
    <button class="dropbtn" style="font-size: large;margin-top: 7px;">Eamcet Rank 
     ...
     <div class="dropdown-content">
      ...
      <a href="filters.jsp?r=<%=130000%>">lessthan or equals 200,000</a>
    </div> 
  </div> 
  <div class="dropdown">
  ...
  else if(request.getParameter("typese").equals("college")){
	  %>
	  <div class="dropdown">
				          ...
				          <div class="w3-col s3">
				            ...
				            <br>
				                ...
				                <center>
				                 <h4 style="text-decoration:underline;font-weight:bold;"><%=rs.getString(1) %></h4>
				                 Location:<h6 ><%=rs.getString(2) %></h6>
				              <button><a href="knowmore.jsp?ts=<%=2%>&clgname=<%=rs.getString(1) %>" style="text-decoration: none; color: black;">Know More</a></button>  
				            	</center>
				            </div>
				 		</div>
	  ...
	  String ems=(String)session.getAttribute("email");
		if(ems!=null)
		{
			...
			try{
				...
				PreparedStatement pstmt=con.prepareStatement("select * from internships");
				ResultSet rs=pstmt.executeQuery();
