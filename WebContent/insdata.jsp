...
<%
String oks=request.getParameter("t");
  	...
  	else if(oks.equals("users"))
  	{
		...
		<center>
			<div class="w3-panel w3-card">
				<br>
						<img src="viewimage.png">
				<h3>View All Users Data</h3>
				<a href="clgsdatabase.jsp?outer=<%="5" %>" class="btn btn-primary">View</a>
			</div>
		</center>
		</div>
		...
		<center>
			<div class="w3-panel w3-card">
				...
				<a href="clgsdatabase.jsp?outer=<%="6" %>" class="btn btn-primary">View</a>
			</div>
		</center>
		</div>
