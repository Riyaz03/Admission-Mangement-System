...
<div class="navbar">
  ...
  %>
         ...
         <form action="newfilter.jsp" method="post">
	           	<div style="margin-top:5px;">
	           		<h5 style="text-decoration: underline;">Enter Eamcet Rank</h5>
  ...
  if(l!=null && g!=null)
	{
		...
		else if(l.length()!=0 && g.length()==0)
		{
			try{
				...
				Class.forName("oracle.jdbc.driver.OracleDriver");
				con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","epproject","epproject");
				PreparedStatement pstmt1=con.prepareStatement("select * from universities where min_eamcet<=?");
		...
		else if(l.length()!=0 && g.length()!=0)
		{
			try{
				...
				Class.forName("oracle.jdbc.driver.OracleDriver");
				con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","epproject","epproject");
				PreparedStatement pstmt2=con.prepareStatement("select * from universities where min_eamcet>=? AND min_eamcet<=?");
