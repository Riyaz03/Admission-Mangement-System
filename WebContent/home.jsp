...
<div class="w3-panel w3-card">
  <div class="w3-row">
          <div class="w3-col s6"><br><br><br><h2>Pursuing B.Tech!</h2> Join In Internships by availing Internship Offers From Our Website...
             <br><a href="mainpage.jsp?typese=<%=intern %>" type="button" style="margin-left:200px;margin-top: 50px; text-decoration: none;display: block;  width: 140px;" role="button" class="w3-btn w3-blue w3-border">Explore ></a>
          </div>
...
<br><br>
  ...
  <div class="w3-row">
          <div class="w3-col s6"><br><br><br><h2>Completed Intermediate!</h2>Explore Our Website To get Admission In Your Dream University...
              <br><a href="mainpage.jsp?typese=<%=uni %>" type="button" style="margin-left:200px;margin-top: 50px; text-decoration: none;display: block;  width: 140px;" role="button" class="w3-btn w3-blue w3-border">Explore ></a>
          </div>
